  ...
  return (
    <SafeAreaView edges={['top']} style={{ flex: 1, backgroundColor: theme.bg }}>
      <View style={{ flexDirection: 'row', alignItems: 'center', paddingHorizontal: 18, height: 54, gap: 14 }}>
        ...
        <Text style={{ fontFamily: FONT.serif, fontSize: 24, color: theme.ink, letterSpacing: -0.3 }}>Terms of Service</Text>
      </View>

      <ScrollView contentContainerStyle={{ paddingHorizontal: 22, paddingBottom: 60, gap: 22 }}>
        <Text style={{ fontFamily: FONT.monoMedium, fontSize: 10, color: theme.muted, letterSpacing: 1.4, textTransform: 'uppercase', marginTop: 8 }}>
          Last updated: January 1, 2025 · Version 1.0
        </Text>

        <Section theme={theme} title="1. Eligibility">
        ...
        <Section theme={theme} title="2. Skill-Based Game">
        ...
        <Section theme={theme} title="3. Real-Money Play">
        ...
        <Section theme={theme} title="4. Responsible Gaming">
        ...
        <Section theme={theme} title="5. Account Security">
        ...
        <Section theme={theme} title="6. Prohibited Conduct">
        ...
        <Section theme={theme} title="11. Limitation of Liability">
        ...
        <Section theme={theme} title="12. Changes to Terms">
        ...
        <Text style={{ fontFamily: FONT.sans, fontSize: 12, color: theme.muted2, textAlign: 'center', marginTop: 16, lineHeight: 18 }}>
...
function Section({ title, children, theme }: { title: string; children: string; theme: Theme }) {
  return (
    <View style={{ gap: 8 }}>
      <Text style={{ fontFamily: FONT.sansBold, fontSize: 14, color: theme.ink, letterSpacing: 0.2 }}>{title}</Text>
      <Text style={{ fontFamily: FONT.sans, fontSize: 14, color: theme.ink2, lineHeight: 22 }}>{children}</Text>
    </View>
  );
}
